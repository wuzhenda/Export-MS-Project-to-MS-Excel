Attribute VB_Name = "ExportResouce2Excel"
...
Sub ExportResouce2Excel()

    If ActiveProject.Resources.Count = 0 Then
        MsgBox "Your project Resources is emty!"
        Exit Sub
    End If
...
'number of active tasks
    ...
    For Each myResource In ActiveProject.Resources
        If Not myResource Is Nothing Then
            If Not myResource.IsTeam Then
                myResourceCount = myResourceCount + 1
            End If
        End If
    Next myResource
...
'https://stackoverflow.com/questions/30026572/how-to-find-the-start-date-of-week-from-a-given-date
    ...
    Next i
    'end of i loop,which draw gantt chart head
...
'end close
    ...
    'begin to fill the content of the excel,the above drawed the head
    ...
    For Each myResource In ActiveProject.Resources
        'here we should get the resource task
        For Each myAssignment In myResource.Assignments
            Set myTask = myAssignment.Task
